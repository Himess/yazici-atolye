...
export const products: Product[] = [
  ...
  },
  {
    ...
    about: "14 Ayar Altin Erkek Alyans, zamansiz elegansini modern cizgilerle bulusturan ozel bir parca. Comfort fit ic yapisi sayesinde gun boyu rahat kullanim saglar. Uretimden direkt size ulastirilan bu alyans, piyasa fiyatinin cok altinda sunulmaktadir.",
    price: 8500,
    oldPrice: 14500,
    category: "yuzuk",
  ...
  },
  {
    ...
    about: "14 Ayar Altin Kadin Alyans, incelik ve zarafetin simgesi. Ince profili ile her gun rahatlikla takilabilir. Atölyemizde el iscigiyle uretilen bu alyans, buyuk kuyumculara toptan satis yaptigimiz ayni kalitede, ancak aracisiz fiyatla sizlere sunulmaktadir.",
    price: 5500,
    oldPrice: 9500,
    category: "yuzuk",
    categoryLabel: "Alyans",
  ...
  },
  {
    ...
    about: "Melek Kanadi Pirlanta Kolye, kanat detaylari uzerinde isiyan pirlantalarla goz kamastirici bir gorunum sunar.",
    price: 32000,
    oldPrice: 38000,
    category: "kolye",
    categoryLabel: "Kolye",
