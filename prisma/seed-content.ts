...
const contents = [
  ...
  { page: 'anasayfa', section: 'uretim', key: 'items', value: '[{"image":"/images/atolye-usta-1.png","title":"40 Yıllık Tecrübe","description":"Usta ellerden, özenle işlenen parçalar"},{"image":"/images/atolye-3.png","title":"El İşçiliği","description":"Her parça, tek tek elle üretilir"},{"image":"/images/atolye-4.png","title":"Kalite Garantisi","description":"Sertifikalı malzeme, titiz işçilik"}]', type: 'textarea' },
